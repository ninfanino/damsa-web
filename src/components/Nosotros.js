				...
				<div id="demo" className="carousel slide" data-ride="carousel">
					<div className="carousel-inner">
						<div className="carousel-item active">
									<img className="imgNosotros" src="../images/bg-nosotros.png" />

										<div className="carousel-caption  d-md-block" >

												<h1  className="sliderh1">CONÓCENOS   </h1>
												<p className="sliderP2">TE VAS A QUERER QUEDAR CON</p>
												<p className="sliderP2">NOSOTROS</p>
							              ...
							              <ul id="cont1">
											...
											<div className="row">
															...
															<div id="sembla" className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
																...
																<h3 > EMPLEADOS</h3>
																	<div className="contenedor1">
																<p id="cont1"> Desde nuestro origen en 1996, hemos prodesado alrededor de 50 millones de nóminas, para cerca de
															...
															<div id="sembla" className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
																...
																<h3>CLIENTES SATISFECHOS</h3>
																	<div className="contenedor1">
																	<p id="cont1"> Somos socios comerciales de todo tipo de empresas, desde Pequeñas y Medianas Empresas hasta grandes
															...
															<div id="sembla2" className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
													...
													<div className="row">
									                    ...
									                    <div className="col-sm-12" >
									                      <a  href="#" className="decoration-none">  <h4 className="texto ers2" id="tuto" > Reporte anual de responsabilidad social</h4> </a>
									                    </div>
									                  </div>
																	</div>
																	...
																	<div id="sembla" className="col-xs-12 col-sm-12 col-md-12 col-lg-4">
																		<h3 > Política de Responsabilidad Social</h3>
																			<div className="contenedor1">
																		<p id="cont1"> Es el compromiso que busca la sustentabilidad de la empresa y delas partes interesadas, por lo tanto,
																	...
																	<div id="sembla" className="col-xs-12 col-sm-12 col-md-12 col-lg-4">
																		<h3>Política de Calidad</h3>
																			<div className="contenedor1">
																			<p id="cont1"> DAMSA está dedicada a ofrecer soluciones integrales de tercerización de recursos humanos flexibles y adaptables a las necesidades de nuestros clientes y partes interesadas.</p>
																			<p id="cont1"> Lo anterior mediante el cumplimiento de los siguientes compromisos:
																			</p>
																			<ul id="cont1">
																	...
																	<div id="sembla" className="col-xs-12 col-sm-12 col-md-12 col-lg-4">
																		<h3>Política de Ética</h3>
																			<div className="contenedor1">
																			<p id="cont1">DAMSA institucionalmente cumple todas las leyes y normatividades que le aplican por su giro empresarial, mantiene canales de comunicación para denuncias, evitando represalias, y además promueve y vigila permanentemente una conducta ética y anticorrupción entre sus colaboradores y partes interesadas, en todos los aspectos, evitando ventajas inapropiadas, respetando la propiedad intelectual, la privacidad y veracidad de la información como parte de su actual cotidiano.</p>
																		</div>
																	</div>
																	<div id="sembla" className="col-xs-12 col-sm-12 col-md-12 col-lg-4">
																		<h3>Política de Comunicación</h3>
																			<div className="contenedor1">
																			<p id="cont1">En DAMSA valoramos la opinión de nuestros colaboradores y partes interesadas por eso mantenemos canales de comunicación efectivos, seguros y confidenciales para emitir y recibir información que facilite el logro de metas y objetivos institucionales en todas nuestras áreas y proyectos.</p>
																		</div>
																	</div>
																	<div id="sembla" className="col-xs-12 col-sm-12 col-md-12 col-lg-4">
																		<h3>Política de Sistema de Gestión</h3>
																			<div className="contenedor1">
																			<p id="cont1">En DAMSA es responsabilidad de la dirección y un compromiso institucional el logro de las metas y objetivos por medio de una capacitación constante, comunicación efectiva, cumpliendo requisitos legales y de los clientes, evaluando los riesgos y buscando siempre la mejora continua.
															...
															<div className="row">
																			...
																			<div id="sembla" className="col-xs-12 col-sm-12 col-md-12 col-lg-9">


																					<div className="contenedor1">
																					<p id="cont1"> En DAMSA tenemos una visión de negocios en la que integramos la estrategia de la empresa con las expectativas de la comunidad con la que nos relacionamos. Buscamos maximizar el impacto social y ambiental de nuestras acciones, es por esto que reconocemos en nuestras estrategias y sistemas de planeación, los intereses de nuestros clientes, colaboradores y proveedores, así como el cuidado del planeta. Este vínculo se fundamenta en nuestros valores y se plasma en nuestras políticas.
																					</p> <br></br>
																					<p id="cont1"> Nuestra continua búsqueda por la excelencia nos ha llevado a cumplir con certificaciones y obtener reconocimientos que respaldan nuestro compromiso con nuestros clientes y la calidad y seguridad de sus procesos, sus objetivos y la calidad de vida del personal que administramos.
																					</p><br></br>
																					<p id="cont1"> Por estas acciones, DAMSA ha sido distinguida por el Centro Mexicano para la Filantropía - CEMEFI - como una empresa socialmente responsable.</p>
																				</div>
																			</div>
																	...
																	<div className="row">
																			...
																			<div className="row">
																							...
																							<div id="sembla" className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
																									...
																									<div className="contenedor1">
																									<p id="cont1"> Es nuestro compromiso mantener y mejorar las prácticas que nos han llevado a estas distinciones y que nos ayudan a impulsar nuestro desarrollo, el de nuestros socios comerciales, proveedores y colaboradores.
																									</p> <br></br>
																									<p id="cont1"> Hoy por hoy la responsabilidad social debiera ser inherente a las operaciones de todas las empresas, y ante tanta competencia, el diferenciador será que aunado a la conciencia del consumidor, el proveedor ofrezca soluciones alineadas a prácticas de sostenibilidad que le permita ofrecer un servicio de calidad, justo y con beneficios para todos los que se relacionan con ella.
																									</p><br></br>
																									<p id="cont1"> Seguiremos fomentando acciones que ayuden a satisfacer las necesidades del presente sin comprometer las necesidades futuras de nuestro entorno, practicando un comercio justo, promoviendo una sociedad más fuerte y un planeta más sustentable.</p>
																								</div>
																							</div>
